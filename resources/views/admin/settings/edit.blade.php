    ...
    <div class="row">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>  تعديل {{ ['slider' => 'سلايدر' , 'services'=> 'خدماتنا' , 'abouts' => 'نبذة', 'projects'=> 'مشاريعنا'][ request()['type'] ?? $setting->type ]  }}
                </div>
                <div class="tools">
            ...
            <div class="portlet-body form" style="display: block;">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ route('company.settings.update' , ['id'  =>  $setting->id  ,'services' => $setting->type ]) }}" role="form" style="padding: 15px">
@csrf
