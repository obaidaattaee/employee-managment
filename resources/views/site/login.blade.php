                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-6">
                            <form class="contact-form" method="post" action="{{ route('login') }}">
                                <input type="hidden" name="_token" value="Nwn5dNKdjhwbQ7YlR6jCqHJiGkTCM49nk1QCQmfk">
                                <div class="contact-one m-b30">
                                        ...
                                        <div class="mt-separator-outer separator-left">
                                            <div class="mt-separator">
                                                <h2 class="text-uppercase sep-line-one "><span
                                                        class="font-weight-300 text-primary"> تسجيل </span>الدخول </h2>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- TITLE END -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <button name="submit" type="submit" value="Submit"
                                                class="site-button btn-effect">تسجيل الدخول
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <a href="{{ route('home') }}" class="site-button btn-effect">رجوع </a>
                            ...
                            <div class="contact-info m-b30">
                                ...
                                <div class="section-head">
                                    <div class="mt-separator-outer separator-left">
                                        <div class="mt-separator">
                                            <h2 class="text-uppercase sep-line-one "><span
                                                    class="font-weight-300 text-primary">اتصل</span> معلومات</h2>
                                        </div>
                                    </div>
                                </div>
                                <!-- TITLE END -->
