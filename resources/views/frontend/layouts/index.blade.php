...
<body>
	...
	<div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <!-- SLIDER START -->
            @include("frontend.layouts.admin.slider")

            <!-- SLIDER END -->

            <!-- OUR SPECIALLIZATION START -->
            @include('frontend.layouts.admin.special')

            <!-- OUR SPECIALLIZATION END -->

            <!-- ABOUT COMPANY START -->
            @include('frontend.layouts.admin.company')
            <!-- ABOUT COMPANY END -->

            <!-- OUR VALUE START -->
            {{-- @include('frontend.layouts.admin.value') --}}

            <!-- OUR VALUE END -->

{{--
            <!-- OUR SERVICES START -->
            @include('frontend.layouts.admin.services')

            <!-- OUR SERVICES  END -->

            <!-- CALL US SECTION START -->
            @include('frontend.layouts.admin.call_us')

            <!-- CALL US SECTION END --> --}}

            <!-- OUR PROJECT START -->
            @include('frontend.layouts.admin.project')
            <!-- OUR PROJECT END -->

             <!-- OUR Team START -->
             @include('frontend.layouts.admin.team')

            <!-- OUR Team END -->

             <!-- Our PRICING PLAN -->
             @include('frontend.layouts.admin.pricing')

            <!-- Our PRICING PLAN -->

            <!-- CLIENT LOGO SECTION START -->
            {{-- @include('frontend.layouts.admin.client_logo') --}}

            <!-- CLIENT LOGO  SECTION End -->

            <!-- OUR MISSION START -->
            @include('frontend.layouts.admin.mission')
