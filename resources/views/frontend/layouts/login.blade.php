                    ...
                    <div class="section-content">
                        ...
                        <div class="row">
                        	<div class="col-md-8 col-sm-6">
                                <form class="contact-form cons-contact-form" method="post" action="{{route('login')}}">
                                    @csrf
                                ...
                                <div class="col-md-6 form-group">
                                    <a href="{{route('register_form')}}">
                                        <button name="submit" type="submit" value="Submit" class="site-button btn-effect">تسجيل موظف/عميل جديد</button>
                                    </a>
                                </div>

                                <div class="col-md-6 form-group">
                                    <a href="{{route('registerc_form')}}">
                                        <button name="submit" type="submit" value="Submit" class="site-button btn-effect">تسجيل شركه جديد</button>
                                    </a>
                                </div>
                            </div>
