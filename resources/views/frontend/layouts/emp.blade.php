                    ...
                    <div class="section-content">
                        ...
                        <div class="row">
                        	<div class="col-md-8 col-sm-6">
                                    ...
                                    <!-- TITLE END -->
                                <form class="contact-form" method="post" action="{{ route('emp_store') }}">
                                    @csrf
                                    <div class="contact-one m-b30">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input disabled name="emp_id" type="text" required class="form-control"  value="{{Auth::user()->name}}">
                                        </div>
                                                ...
                                                <select name="type_id" class="form-control">
                                                    ...
                                                    @foreach($emos as $emo)
                                                        <option class="form-control select2 "
                                                                {{(request()->get('emo_id'))== $emo->id?"selected":""}} value='{{$emo->id}}'>{{$emo->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input name="address" type="text" required class="form-control" placeholder="مكان العمل">
                                        </div>

                                        <div class="col-md-6 form-group">
                                            <label>مصاريف تشغيلية</label>
                                            <input name="payment" type="text" required class="form-control" placeholder="مصاريف تشغيلية">
                                        </div>

                                        <div class="col-md-6 form-group">
                                            <label> ساعات العمل</label>
                                            <input name="hour" type="text" required class="form-control" placeholder="ساعات العمل">
                                        </div>

                                        <div class="col-md-6 form-group">
                                            <label>  ساعات العمل الاضافية</label>
                                            <input name="hour_plus" type="text" required class="form-control" placeholder="ساعات العمل الاضافية">
                                        </div>
