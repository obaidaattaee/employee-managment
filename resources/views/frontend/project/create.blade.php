...
@section('content')
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i> إضافة مشروع
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ route('projects.store') }}" role="form">
                            @csrf
                        <div class="form-body">
                            ...
                            <div class="form-group has-success">
                                <label for="form_control_1">خدمة</label>
                                <select name="service_id" class="form-control">
                                    <option value="">اختار خدمة</option>
                                    @foreach($services as $service)
                                        <option
                                            {{old('service_id')== $service->id?"selected":""}} value='{{$service->id}}'>{{$service->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
