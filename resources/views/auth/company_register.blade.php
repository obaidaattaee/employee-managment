...
<div class="content">
    ...
    <form class="" action="{{route('company.register.store')}}" method="post">
        @csrf

		<div class="form-title">
			<span class="form-title">تسجيل شركة جديدة</span>
		</div>
		<p class="hint">
		...
		<div class="form-group">
			...
			<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="اسم الشركة" name="title"/>
		</div>
		<div class="form-group">
