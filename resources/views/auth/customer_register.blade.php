...
<div class="content">
    ...
    <form class="" action="{{route('register')}}" method="post">
		...
		<div class="form-title">
			<span class="form-title">تسجيل  زبون جديد</span>
		</div>
		<p class="hint">
			 ادخل المعلومات المطلوبه بالاسفل :
		</p>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">اسم الزبون</label>
		...
		<div class="form-group">
			...
			<input class="form-control placeholder-no-fix" type="hidden" value="customer" placeholder="الايميل" name="type"/>
		</div>
        <div class="form-group">
        ...
        <div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">كود الشركة التابع لها </label>
			<input class="form-control placeholder-no-fix" type="number" autocomplete="off" placeholder="كود الشركة التابع لها " name="code"/>
		</div>
		<div class="form-group">
